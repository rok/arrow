...
cdef shared_ptr[ArrowWriterProperties] _create_arrow_writer_properties(
        ...
        write_fixed_size_list_as_fixed_len_byte_array=False) except *:
    ...
    if write_fixed_size_list_as_fixed_len_byte_array:
        arrow_props.enable_fixed_size_list_as_fixed_len_byte_array()
    else:
        arrow_props.disable_fixed_size_list_as_fixed_len_byte_array()
