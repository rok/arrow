...
- To learn more about writing dplyr bindings as an arrow developer, see the "Writing bindings" section of the `register_binding()` documentation in [`r/R/dplyr-funcs.R`](https://github.com/apache/arrow/blob/main/r/R/dplyr-funcs.R).
