...
Alternatively, you may prefer to use the [Archery tool to run docker images](https://arrow.apache.org/docs/developers/continuous_integration/docker.html).
...
This is the same tool which our CI uses - via a tool called [Crossbow](https://arrow.apache.org/docs/developers/continuous_integration/crossbow.html).
