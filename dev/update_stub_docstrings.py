...
def update_stub_file(stub_file):
    package = griffe.load("pyarrow", try_relative_path=False,
    ...
    cloned_signature_transformer = ClonedSignatureDocstringTransformer(
        docstrings_map, "pyarrow.compute")
    function_docstring_transformer = FunctionDocstringTransformer(
        docstrings_map, "pyarrow.compute")
