        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->page_locations.resize(_size287);
            uint32_t _i291;
            for (_i291 = 0; _i291 < _size287; ++_i291)
            {
              xfer += this->page_locations[_i291].read(iprot);
            }
            xfer += iprot->readListEnd();
          }
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->unencoded_byte_array_data_bytes.resize(_size292);
            uint32_t _i296;
            for (_i296 = 0; _i296 < _size292; ++_i296)
            {
              xfer += iprot->readI64(this->unencoded_byte_array_data_bytes[_i296]);
            }
            xfer += iprot->readListEnd();
          }
          this->__isset.unencoded_byte_array_data_bytes = true;
...
uint32_t OffsetIndex::write(Protocol_* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("page_locations", ::apache::thrift::protocol::T_LIST, 1);
  {
    ...
    std::vector<PageLocation> ::const_iterator _iter297;
    for (_iter297 = this->page_locations.begin(); _iter297 != this->page_locations.end(); ++_iter297)
    {
  ...
  if (this->__isset.unencoded_byte_array_data_bytes) {
    xfer += oprot->writeFieldBegin("unencoded_byte_array_data_bytes", ::apache::thrift::protocol::T_LIST, 2);
    {
      ...
      for (_iter298 = this->unencoded_byte_array_data_bytes.begin(); _iter298 != this->unencoded_byte_array_data_bytes.end(); ++_iter298)
      {
    ...
    switch (fid)
    {
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->null_pages.resize(_size303);
            uint32_t _i307;
            for (_i307 = 0; _i307 < _size303; ++_i307)
            {
              xfer += iprot->readBool(this->null_pages[_i307]);
            }
            xfer += iprot->readListEnd();
          }
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->min_values.resize(_size308);
            uint32_t _i312;
            for (_i312 = 0; _i312 < _size308; ++_i312)
            {
              xfer += iprot->readBinary(this->min_values[_i312]);
            }
            xfer += iprot->readListEnd();
          }
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->max_values.resize(_size313);
            uint32_t _i317;
            for (_i317 = 0; _i317 < _size313; ++_i317)
            {
              xfer += iprot->readBinary(this->max_values[_i317]);
            }
            xfer += iprot->readListEnd();
          }
      ...
      case 4:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->boundary_order = static_cast<BoundaryOrder::type>(ecast318);
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->null_counts.resize(_size319);
            uint32_t _i323;
            for (_i323 = 0; _i323 < _size319; ++_i323)
            {
              xfer += iprot->readI64(this->null_counts[_i323]);
            }
            xfer += iprot->readListEnd();
          }
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->repetition_level_histograms.resize(_size324);
            uint32_t _i328;
            for (_i328 = 0; _i328 < _size324; ++_i328)
            {
              xfer += iprot->readI64(this->repetition_level_histograms[_i328]);
            }
            xfer += iprot->readListEnd();
          }
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->definition_level_histograms.resize(_size329);
            uint32_t _i333;
            for (_i333 = 0; _i333 < _size329; ++_i333)
            {
              xfer += iprot->readI64(this->definition_level_histograms[_i333]);
            }
            xfer += iprot->readListEnd();
          }
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->nan_counts.resize(_size334);
            uint32_t _i338;
            for (_i338 = 0; _i338 < _size334; ++_i338)
            {
              xfer += iprot->readI64(this->nan_counts[_i338]);
            }
            xfer += iprot->readListEnd();
          }
...
uint32_t ColumnIndex::write(Protocol_* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("null_pages", ::apache::thrift::protocol::T_LIST, 1);
  {
    ...
    std::vector<bool> ::const_iterator _iter339;
    for (_iter339 = this->null_pages.begin(); _iter339 != this->null_pages.end(); ++_iter339)
    {
      xfer += oprot->writeBool((*_iter339));
    }
    xfer += oprot->writeListEnd();
  }
  xfer += oprot->writeFieldEnd();
  ...
  xfer += oprot->writeFieldBegin("min_values", ::apache::thrift::protocol::T_LIST, 2);
  {
    ...
    for (_iter340 = this->min_values.begin(); _iter340 != this->min_values.end(); ++_iter340)
    {
      xfer += oprot->writeBinary((*_iter340));
    }
    xfer += oprot->writeListEnd();
  }
  xfer += oprot->writeFieldEnd();
  ...
  xfer += oprot->writeFieldBegin("max_values", ::apache::thrift::protocol::T_LIST, 3);
  {
    ...
    for (_iter341 = this->max_values.begin(); _iter341 != this->max_values.end(); ++_iter341)
    {
  ...
  if (this->__isset.null_counts) {
    xfer += oprot->writeFieldBegin("null_counts", ::apache::thrift::protocol::T_LIST, 5);
    {
      ...
      for (_iter342 = this->null_counts.begin(); _iter342 != this->null_counts.end(); ++_iter342)
      {
  ...
  if (this->__isset.repetition_level_histograms) {
    xfer += oprot->writeFieldBegin("repetition_level_histograms", ::apache::thrift::protocol::T_LIST, 6);
    {
      ...
      for (_iter343 = this->repetition_level_histograms.begin(); _iter343 != this->repetition_level_histograms.end(); ++_iter343)
      {
  ...
  if (this->__isset.definition_level_histograms) {
    xfer += oprot->writeFieldBegin("definition_level_histograms", ::apache::thrift::protocol::T_LIST, 7);
    {
      ...
      for (_iter344 = this->definition_level_histograms.begin(); _iter344 != this->definition_level_histograms.end(); ++_iter344)
      {
  ...
  if (this->__isset.nan_counts) {
    xfer += oprot->writeFieldBegin("nan_counts", ::apache::thrift::protocol::T_LIST, 8);
    {
      ...
      for (_iter345 = this->nan_counts.begin(); _iter345 != this->nan_counts.end(); ++_iter345)
      {
...
uint32_t FileMetaData::write(Protocol_* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("schema", ::apache::thrift::protocol::T_LIST, 2);
  {
    ...
    std::vector<SchemaElement> ::const_iterator _iter382;
  ...
  xfer += oprot->writeFieldBegin("row_groups", ::apache::thrift::protocol::T_LIST, 4);
  {
    ...
    std::vector<RowGroup> ::const_iterator _iter383;
  ...
  if (this->__isset.key_value_metadata) {
    ...
    {
      xfer += oprot->writeListBegin(::apache::thrift::protocol::T_STRUCT, static_cast<uint32_t>(this->key_value_metadata.size()));
      std::vector<KeyValue> ::const_iterator _iter384;
  ...
  if (this->__isset.column_orders) {
    xfer += oprot->writeFieldBegin("column_orders", ::apache::thrift::protocol::T_LIST, 7);
    {
      ...
      std::vector<ColumnOrder> ::const_iterator _iter385;
