...
class PARQUET_EXPORT LogicalType {
 public:
  ...
  static std::shared_ptr<const LogicalType> FixedSizeList(int32_t num_values);
...
/// \brief Allowed for group nodes only, annotating a list-shaped column.
class PARQUET_EXPORT FixedSizeListLogicalType : public LogicalType {
 public:
  static std::shared_ptr<const LogicalType> Make(int32_t num_values);
