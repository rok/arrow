...
class PARQUET_EXPORT ArrowWriterProperties {
 public:
   ...
   public:
    Builder()
        : write_timestamps_as_int96_(false),
          ...
          write_fixed_size_list_logical_type_(false),
          engine_version_(V2),
    ...
    /// \brief EXPERIMENTAL: Write Arrow FixedSizeList as a Parquet
    /// FIXED_SIZE_LIST logical type annotation.
    ///
    /// When disabled, Arrow FixedSizeList is written as a regular Parquet LIST.
    /// This is disabled by default while the logical type is experimental.
    Builder* enable_fixed_size_list_logical_type() {
      write_fixed_size_list_logical_type_ = true;
      return this;
    }

    /// \brief Disable writing the experimental FIXED_SIZE_LIST logical type.
    ...
    std::shared_ptr<ArrowWriterProperties> build() {
      return std::shared_ptr<ArrowWriterProperties>(new ArrowWriterProperties(
          ...
          write_fixed_size_list_logical_type_, engine_version_, use_threads_, executor_,
  ...
  /// \brief Whether to write Arrow FixedSizeList using the experimental Parquet
  /// FIXED_SIZE_LIST logical type annotation.
  bool write_fixed_size_list_logical_type() const {
    return write_fixed_size_list_logical_type_;
  }
 ...
 private:
  explicit ArrowWriterProperties(bool write_nanos_as_int96,
                                 ...
                                 bool write_fixed_size_list_logical_type,
      ...
      : write_timestamps_as_int96_(write_nanos_as_int96),
        ...
        write_fixed_size_list_logical_type_(write_fixed_size_list_logical_type),
